...
fun ProductCreateScreen(
    ...
    LaunchedEffect(uiState) {
        when (val state = uiState) {
            is ProductCreateUiState.Success -> {
                snackbarHostState.showSnackbar("Product created successfully!")
                onProductCreated(state.product.id)
            }
            is ProductCreateUiState.Error -> {
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                singleLine = true,
                enabled = uiState !is ProductCreateUiState.Loading
            )
            ...
            // Loading indicator
            if (uiState is ProductCreateUiState.Loading) {
